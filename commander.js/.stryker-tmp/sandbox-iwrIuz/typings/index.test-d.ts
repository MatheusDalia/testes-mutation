...
//  Check that Command is strongly typed and does not allow arbitrary properties
...
//  Check that options strongly typed and does not allow arbitrary properties
...
// : Option helpGroup() can not be used as a getter.
